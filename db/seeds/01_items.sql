...
VALUES
  ('Appetizers', 'Món khai Vị', 'Spring Rolls', 'Chả Giò', '2 rolls', 5.99, 0),
  ('Appetizers', 'Món khai Vị', 'Spring Rolls', 'Chả Giò', '4 rolls', 5.99, 1.00);

-- Wontons options
INSERT INTO items (section, section_vietnamese, name, name_vietnamese, item_option, base_price, price_adjustment)
VALUES
  ('Appetizers', 'Món khai Vị', 'Wontons', 'Hoành Thánh Tôm Chiên', '4 pieces', 6.99, 0);
...
INSERT INTO items (section, section_vietnamese, name, name_vietnamese, item_option, base_price, price_adjustment)
VALUES
  ('Rice Noodle Soup', 'Phở', 'Beef Noodle Soup', 'Phở', 'small', 10.99, 0),
